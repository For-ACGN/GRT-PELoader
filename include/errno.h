...
#define ERR_LOADER_FLUSH_INST      (0x10000006)
#define ERR_LOADER_CREATE_G_MUTEX  (0x10000007)
#define ERR_LOADER_CREATE_EC_MUTEX (0x10000008)
...
#define ERR_LOADER_CLEAN_EC_MUTEX  (0x1000FF02)
#define ERR_LOADER_CLEAN_FREE_PE   (0x1000FF03)
#define ERR_LOADER_CLEAN_FREE_MEM  (0x1000FF04)
#define ERR_LOADER_RECOVER_INST    (0x1000FF05)

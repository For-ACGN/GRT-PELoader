...
#define ERR_LOADER_CLOSE_G_MUTEX    (0x01000204)
#define ERR_LOADER_CLOSE_EC_MUTEX   (0x01000205)
#define ERR_LOADER_FREE_PE_IMAGE    (0x01000206)
#define ERR_LOADER_FREE_MAIN_PAGE   (0x01000207)
